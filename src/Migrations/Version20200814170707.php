 ...
 */
final class Version20200813092458 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE frais (id INT AUTO_INCREMENT NOT NULL, id_statut_frais_id INT DEFAULT NULL, id_type_frais_id INT DEFAULT NULL, id_trajet_id INT DEFAULT NULL, id_client_id INT DEFAULT NULL, id_commercial_id INT DEFAULT NULL, montant DOUBLE PRECISION DEFAULT NULL, date DATETIME NOT NULL, scan VARCHAR(255) DEFAULT NULL, commentaire VARCHAR(255) DEFAULT NULL, INDEX IDX_25404C98290912ED (id_statut_frais_id), INDEX IDX_25404C98CC869B5D (id_type_frais_id), INDEX IDX_25404C988D271404 (id_trajet_id), INDEX IDX_25404C9899DED506 (id_client_id), INDEX IDX_25404C98C67CD679 (id_commercial_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE trajet (id INT AUTO_INCREMENT NOT NULL, id_client_id INT NOT NULL, label VARCHAR(255) NOT NULL, date_debut DATE NOT NULL, date_fin DATE DEFAULT NULL, commentaire VARCHAR(255) DEFAULT NULL, INDEX IDX_2B5BA98C99DED506 (id_client_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE utilisateur (id INT AUTO_INCREMENT NOT NULL, id_role_id INT NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, telephone VARCHAR(20) NOT NULL, username VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, INDEX IDX_1D1C63B389E8BDC (id_role_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
